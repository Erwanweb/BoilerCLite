...
"""
"""
<plugin key="BoilerCLite" name="AC Boiler control LITE" author="Erwanweb" version="0.0.2" externallink="https://github.com/Erwanweb/BoilerCLite.git">
    <description>
    ...
    <params>
        ...
        <param field="Mode5" label="Delay : On, order confirm. (all in minutes)" width="200px" required="true" default="5,60"/>
...
class BasePlugin:
    ...
    def onStart(self):
        ...
        if len(params) == 2:
            self.ondelay = CheckParam("On Delay",params[0],5)
            if self.ondelay < 5:
